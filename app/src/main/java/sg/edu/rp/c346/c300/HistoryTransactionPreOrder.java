...
public class HistoryTransactionPreOrder extends AppCompatActivity {

    TextView noNotification;

    private ListView listView;
    private CollectionAdapter preOrderListAdapter;
    private CollectionWalkInAdapter walkInListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history_transaction_pre_order);
        ...
        if (page.equals("PreOrder")) {
            ...
            notificationTitle.setText("PreOrder History");
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    preOrderListAdapter = new CollectionAdapter(HistoryTransactionPreOrder.this, preOrderContentList, false);
            ...
            notificationTitle.setText("Walk-In Order History");
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    walkInListAdapter = new CollectionWalkInAdapter(HistoryTransactionPreOrder.this, walkInContentList);
        ...
        drHC.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(int i =numOfPreOrder-1; i>=0;i--){
                    ...
                    NotificationHeader notificationHeader = new NotificationHeader(foodName, status, dateTimePurchased, image);
